...
const Hero = () => {
  return (
    <div className={styles.hero}>
      Стандартний Lorem Ipsum, використовуваний з XVI ст. "Lorem ipsum dolor sit
      amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
      labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
      exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis
      aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
      fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident,
      sunt in culpa qui officia deserunt mollit anim id est laborum." Розділ
      1.10.32 "de Finibus Bonorum et Malorum", написаного Цицероном у 45 році до
      н.е. "Sed ut perspiciatis unde omnis iste natus error sit voluptatem
      ...
      nulla pariatur?" Переклад Х.Рекема англійською, 1914 "But I must explain
      ...
      pain that produces no resultant pleasure?" Розділ 1.10.33 "de Finibus
      Bonorum et Malorum", написаного Цицероном у 45 році до н.е. "At vero eos
      ...
      perferendis doloribus asperiores repellat." Переклад Х.Рекема англійською,
